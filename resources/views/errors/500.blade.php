...
<body>
  <div class="d-flex align-items-center justify-content-center  bg-black text-white" style="height: 100vh">
    <div class="text-center d-flex flex-column mx-4">
      <span class="fw-medium user-select-none" style="font-size: 80px">500</span>
      <span class=" user-select-none" style="font-size: 24px">Server Error</span>
      <span class="fw-light mt-4 user-select-none" style="font-size: 16px">The server encountered an error and could not
        complete your request.</span>
    </div>
  </div>
</body>
