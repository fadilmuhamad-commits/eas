...
<body>
  <div class="d-flex align-items-center justify-content-center bg-black text-white" style="height: 100vh">
    <div class="text-center d-flex flex-column mx-4">
      <span class="fw-medium user-select-none" style="font-size: 80px">403</span>
      <span class=" user-select-none" style="font-size: 24px">Forbidden</span>
      <span class="fw-light mt-4 user-select-none" style="font-size: 16px">You do not have access to this page or
        resource.</span>
    </div>
  </div>
</body>
